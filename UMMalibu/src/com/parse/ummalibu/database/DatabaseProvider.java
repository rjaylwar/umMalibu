...
public class DatabaseProvider extends ContentProvider {
    ...
    private static final int TUMBLR_TALKS = 4;
    ...
    static {
        ...
        mUriMatcher.addURI(AUTHORITY, Table.TumblrTalks.TABLE_NAME, TUMBLR_TALKS);
    }
    ...
    public String getType(@NonNull Uri uri) {
        switch(mUriMatcher.match(uri)) {
            ...
            case TUMBLR_TALKS :
                return Table.TumblrTalks.CONTENT_ITEM_TYPE;
            default :
    ...
    public static String getTable(Uri uri) {
        switch(mUriMatcher.match(uri)) {
            ...
            case TUMBLR_TALKS :
                return Table.TumblrTalks.TABLE_NAME;
            default :
                throw new IllegalArgumentException("uri not matched");
        }
    }

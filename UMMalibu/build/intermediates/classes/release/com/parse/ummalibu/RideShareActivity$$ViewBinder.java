...
public class RideShareActivity$$ViewBinder<T extends com.parse.ummalibu.RideShareActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131689803, "field 'mTabLayout'");
    target.mTabLayout = finder.castView(view, 2131689803, "field 'mTabLayout'");
    view = finder.findRequiredView(source, 2131689630, "field 'mViewPager'");
    target.mViewPager = finder.castView(view, 2131689630, "field 'mViewPager'");
  }
